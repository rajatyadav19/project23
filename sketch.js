...
function setup() {
	...
	ground1Sprite=createSprite(380, 650, 150, 10);
	ground1Sprite.shapeColor = color("red");

	ground2Sprite=createSprite(300, 630, 10, 50);
	ground2Sprite.shapeColor = color("red");

	ground3Sprite=createSprite(450, 630, 10, 50);
...
function keyPressed() {
 if (keyCode === DOWN_ARROW) {
	...
	Matter.Body.set(packageBody,{restitution: 0.3})
  }
}
